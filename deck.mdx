...
-   For testing all JavaScript code, popular with React, React Native communities.
...
<ul style={{ fontSize: 40, textAlign: 'left' }}>
    <Appear>
        ...
        <li>Default browser-like environment.</li>
...
-   API encourages testing implementation details.
...
<ul style={{ fontSize: 40, textAlign: 'left' }}>
    <Appear>
        ...
        <li>Testing like a real user === less broken tests.</li>
        <li>Simple API, no extra config or adapters needed.</li>
    </Appear>
</ul>

<CodeBlock>const hello = () => 'world';</CodeBlock>
